...
- name: AWS Direct Connect API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-direct-connect/master/_listings/aws-direct-connect/action-untagresource-get.md
x-common:
- type: x-change-log
